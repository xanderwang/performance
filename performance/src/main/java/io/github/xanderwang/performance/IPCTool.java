...
class IPCTool {
    ...
    private static void endTransact(Object ipcInterface, Object methodToken, StackTraceElement[] startTrace) {
    ...
    private static void hookIPC() {
        try {
            if (HookBridge.isSandHook() /*|| HookBridge.isEpic()*/) {
                ...
                HookBridge.findAndHookMethod(binderProxyClass, "transact", int.class, Parcel.class, Parcel.class,
                    int.class, new BinderTransactProxyHook());
            } else {
